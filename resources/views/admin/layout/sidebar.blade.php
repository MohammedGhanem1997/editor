   <div class="wrapper">
    ...
    <nav id="sidebar">
        <div class="sidebar-header">
            <h3> {{\App\Models\SiteControl::first()->site_name}}</h3>
        </div>
        ...
        <ul class="list-unstyled components">
            ...
            <li>
                <a href="#admin" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fas fa-user-shield"></i>  admins </a>
                <ul class="collapse list-unstyled" id="admin">
                    <li>
                        <a href="{{route('admin.admin.create')}}"><i class="far fa-plus-square"></i>  add admin </a>
                    </li>
                    <li>
                        <a href="{{route('admin.admin.index')}}"><i class="fas fa-globe"></i>  view all admins </a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul class="collapse list-unstyled" id="settings">
                    <li>
                        <a href="{{route('admin.setting.seo')}}"><i class="fas fa-globe"></i> SEO </a>
                    </li>
                    <li>
                        <a href="{{route('admin.setting.site-control')}}"><i class="fas fa-sitrox"></i> site control </a>
                    </li>
                    <li>
                    </li>
                </ul>
