...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-3 mb-4">
            <div class="card-admin-dash text-white bg-info mb-3" style="max-width: 18rem;">
                <div class="card-header-admin-dash"><i class="fa fa-eye"></i> number of visitor  </div>
                <div class="card-body-admin-dash">
                    <h5 class="card-title"><span class="car-span"></span> {{\App\Models\SiteControl::first()->seen}} </h5>
                    <div class="col-md-12">
                        <a class="btn btn-outline-light d-grid gap-2 car-but" href=""></a>
                    </div>
                </div>
